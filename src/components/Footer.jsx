...
function Footer() {
    ...
    return (
        <Container fluid className="footer bg-gradient-to-b from-blue-950 to-blue-900 text-white">
            <Row className="justify-center items-center ">
                <Col md="4" className="footer-copywright py-3">
                    <h3 className="text-xl font-bold text-center">Designed and Developed by Michał Bożek</h3>
                </Col>
                <Col md="4" className="footer-copywright py-3">
                    <h3 className="text-xl font-bold text-center">Copyright © {year} SB</h3>
                </Col>
