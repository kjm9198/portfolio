...
const NavBar = () => {
  ...
  return (
    ...
    px-4 text-white bg-blue-300 fixed"
    >
      <div>
      ...
      {nav && (
        <ul className="flex flex-col justify-center items-center absolute top-0 left-0 w-full h-screen bg-gradient-to-b from-blue-300 to-blue-600  ">
          {links.map(({ id, link }) => (
            <li
              key={id}
