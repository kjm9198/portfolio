      ...
      <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4">
        ...
        <div className="flex flex-col justify-center h-full text-center">
          ...
          <p className="text-gray-100 py-4 max-w-md mx-auto">
            ...
            Komputerowych, specializing in Data Analytics with a strong passion
            for data-driven decision making. Enthusiastic about modern data
            analytics technologies like Python, SQL, and Tableau.
          </p>

          <div>
            <Link to="projects" smooth={true} duration={500}>
              <button className="group text-white w-fit px-6 py-3 my-2 flex items-center rounded-md bg-gradient-to-b from-beige-300 to-blue-300 cursor-pointer mx-auto">
                Portfolio
